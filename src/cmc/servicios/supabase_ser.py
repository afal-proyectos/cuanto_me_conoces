...
class SupabaseServicio:
        ...
        try:
            datos = {
                ...
                "hora_creacion": datetime.now(
                    timezone.utc
                ).isoformat(),  # la puedes manejar desde Python o dejar que Supabase la ponga con now() si lo configuraste así.
    ...
    def agregar_pregunta_completa(
        ...
        try:
            ...
            # 2. Relacionar la Pregunta con el Quizz (Tabla intermedia Quizz_Preguntas)
            self.client.table("Quizz_Preguntas").insert(
                {
                    "id_quizz": id_quizz,
                    "id_pregunta": id_pregunta,
            ...
            for opc in lista_opciones:
                ...
                # 3b. Relacionar la Opción con la Pregunta (Tabla intermedia Preguntas_Opciones)
